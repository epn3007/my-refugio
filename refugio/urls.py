...
urlpatterns = [
    ...
    path('reset/(<uidb64>[0-9A-Za-z_\-])/(<token>)/', PasswordResetConfirmView.as_view (template_name= 'registration/password_reset_confirm.html'), name='password_reset_confirm' ),
